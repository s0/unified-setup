...
# GUI
pacman -S i3 python-setuptools xorg-server xorg lightdm lightdm-gtk-greeter rxvt-unicode chromium ttf-dejavu ttf-droid ttf-jetbrains-mono  noto-fonts-emoji feh xcompmgr xclip dmenu redshift thunar gnome-calculator dunst pulseaudio pavucontrol file-roller accountsservice nodejs acpi autorandr
